package java_coding_test.etc;

public class SolutionLv2003_HashMap {
	...
	public static int[] solution(int n, String[] words) {
		...
		java.util.Map<String, String> map = new java.util.HashMap<String, String>(); // key-단어, value-""
		...
		for (int t = 0; t < words.length; t++) {
			...
			if (t > 0) {
				...
				usersInfo[currentUserNumber - 1][2] = !(map.containsKey(words[t])) ? 1 : 0; // 단어가 중복되지 않고(규칙4)
			}
